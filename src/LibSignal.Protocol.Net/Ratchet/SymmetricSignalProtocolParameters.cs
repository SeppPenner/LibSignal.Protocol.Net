namespace LibSignal.Protocol.Net.Ratchet
{
    ...
    public class SymmetricSignalProtocolParameters
    {
        ...
        SymmetricSignalProtocolParameters(ECKeyPair ourBaseKey, ECKeyPair ourRatchetKey, IdentityKeyPair ourIdentityKey, ECPublicKey theirBaseKey, ECPublicKey theirRatchetKey, IdentityKey theirIdentityKey)
        {
        ...
        public static class Builder
        {
            ...
            {
                return new SymmetricSignalProtocolParameters(ourBaseKey, ourRatchetKey, ourIdentityKey, theirBaseKey, theirRatchetKey, theirIdentityKey);
            }
        }
    }
}
